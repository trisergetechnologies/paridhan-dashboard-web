  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.203 1.386c.421-.182.897-.182 1.318 0l1.032.446c.293.127.627.09.884-.096l.924-.676c.377-.276.88-.331 1.307-.141.427.19.7.588.708 1.056l.02 1.145c.005.317.18.61.46.776l.997.582c.407.238.637.69.596 1.159-.04.47-.344.87-.784 1.032l-1.086.399a.865.865 0 00-.566.703l-.153 1.13c-.064.469-.4.857-.862.996-.461.14-.963.01-1.304-.335l-.81-.818a.86.86 0 00-.64-.26h-.001a.86.86 0 00-.64.26l-.81.818c-.341.345-.843.475-1.304.335-.462-.139-.798-.527-.862-.996l-.153-1.13a.865.865 0 00-.566-.703l-1.086-.399c-.44-.162-.744-.562-.784-1.032-.04-.47.189-.92.596-1.159l.997-.582a.86.86 0 00.46-.776l.02-1.145c.008-.468.281-.866.708-1.056.427-.19.93-.135 1.307.141l.924.676c.257.186.591.223.884.096l1.032-.446z"
      />
    </svg>
  );
}

export function SettlementIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.25 6A2.75 2.75 0 016 3.25h12A2.75 2.75 0 0120.75 6v12A2.75 2.75 0 0118 20.75H6A2.75 2.75 0 013.25 18V6zM6 4.75c-.69 0-1.25.56-1.25 1.25v12c0 .69.56 1.25 1.25 1.25h12c.69 0 1.25-.56 1.25-1.25V6c0-.69-.56-1.25-1.25-1.25H6z"
      />
      <path d="M7.75 9a.75.75 0 000 1.5h5.5a.75.75 0 000-1.5h-5.5z" />
      <path d="M7.75 13a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5h-8.5z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14.97 7.47a.75.75 0 011.06 0l1.75 1.75a.75.75 0 11-1.06 1.06L16 9.56v4.19a.75.75 0 01-1.5 0V9.56l-.72.72a.75.75 0 11-1.06-1.06l1.75-1.75z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.25 6.5c0-1.519 1.231-2.75 2.75-2.75h9.5a.75.75 0 010 1.5H7c-.69 0-1.25.56-1.25 1.25V7h13.5c.966 0 1.75.784 1.75 1.75v6.5c0 .966-.784 1.75-1.75 1.75H6.5c-1.242 0-2.25-1.007-2.25-2.25V6.5zM5.75 14.75c0 .414.336.75.75.75h12.75a.25.25 0 00.25-.25v-6.5a.25.25 0 00-.25-.25H5.75v6.25z"
      />
      <path d="M15.25 11.25a1 1 0 100 2 1 1 0 000-2z" />
    </svg>
  );
}